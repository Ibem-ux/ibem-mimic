...
ThemeData get vaultTheme {
  ...
  return ThemeData(
    ...
    appBarTheme: AppBarTheme(
      ...
      elevation: 0,
      iconTheme: const IconThemeData(color: Color(0xFF534AB7)),
      actionsIconTheme: const IconThemeData(color: Color(0xFF534AB7)),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      labelStyle: TextStyle(fontFamily: interFontFamily, color: const Color(0xFF6B6B6B)),
      hintStyle: TextStyle(fontFamily: interFontFamily, color: const Color(0xFF8E8E8E)),
    ),
    ...
    snackBarTheme: SnackBarThemeData(
      ...
      actionTextColor: const Color(0xFF534AB7),
    ...
    textTheme: TextTheme(
      bodyLarge: TextStyle(fontFamily: interFontFamily, fontSize: 16, color: const Color(0xFF1A1A1A)),
      bodyMedium: TextStyle(fontFamily: interFontFamily, fontSize: 14, color: const Color(0xFF1A1A1A)),
      bodySmall: TextStyle(fontFamily: interFontFamily, fontSize: 12, color: const Color(0xFF1A1A1A)),
      titleLarge: TextStyle(fontFamily: interFontFamily, fontSize: 20, fontWeight: FontWeight.bold, color: const Color(0xFF1A1A1A)),
      titleMedium: TextStyle(fontFamily: interFontFamily, fontSize: 18, fontWeight: FontWeight.bold, color: const Color(0xFF1A1A1A)),
      titleSmall: TextStyle(fontFamily: interFontFamily, fontSize: 16, fontWeight: FontWeight.bold, color: const Color(0xFF1A1A1A)),
      headlineLarge: TextStyle(fontFamily: interFontFamily, fontSize: 32, fontWeight: FontWeight.bold, color: const Color(0xFF1A1A1A)),
      headlineMedium: TextStyle(fontFamily: interFontFamily, fontSize: 24, fontWeight: FontWeight.bold, color: const Color(0xFF1A1A1A)),
      labelLarge: TextStyle(fontFamily: interFontFamily, fontSize: 16, fontWeight: FontWeight.w600, color: const Color(0xFF1A1A1A)),
      labelMedium: TextStyle(fontFamily: interFontFamily, fontSize: 14, fontWeight: FontWeight.w500, color: const Color(0xFF1A1A1A)),
    ),
    fontFamily: interFontFamily,
  );
}
